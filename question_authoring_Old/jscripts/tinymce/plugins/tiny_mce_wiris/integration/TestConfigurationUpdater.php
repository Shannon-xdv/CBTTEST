...
class com_wiris_plugin_configuration_TestConfigurationUpdater implements com_wiris_plugin_configuration_ConfigurationUpdater {
    ...
    public function updateConfiguration(&$configuration) {
		...
		$configuration['wiriscachedirectory'] = '/var/www/cbt/question_authoring/jscripts/tinymce/plugins/tiny_mce_wiris/cache';
		$configuration['wirisformuladirectory'] = '/var/www/cbt/question_authoring/jscripts/tinymce/plugins/tiny_mce_wiris/formulas';
    }
}
?>
