...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 10, 2025 at 12:56 PM
...
(1, '2025', '2', 4, 20, '4', '2025-06-10 10:41:27', '', NULL, 0, NULL, NULL, 30, NULL, 'on starttime', 'single question', 'random', 'random', 1, 1, 1, 'yes', 0, 0, 'cbt');
...
--
-- Indexes for table `tbltestquestion`
--
ALTER TABLE `tbltestquestion`
  ADD PRIMARY KEY (`testquestionid`),
  ADD UNIQUE KEY `section_question` (`testsectionid`,`questionbankid`),
  ADD KEY `questionbankid` (`questionbankid`);
...
ALTER TABLE `tbltestinvigilator`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tbltestquestion`
--
ALTER TABLE `tbltestquestion`
...
--
ALTER TABLE `tbltestsection`
  MODIFY `testsectionid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `tbltestsubject`
--
ALTER TABLE `tbltestsubject`
  MODIFY `testsubjectid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
-- Constraints for table `tbltestquestion`
--
ALTER TABLE `tbltestquestion`
  ADD CONSTRAINT `tbltestquestion_ibfk_1` FOREIGN KEY (`questionbankid`) REFERENCES `tblquestionbank` (`questionbankid`),
  ADD CONSTRAINT `tbltestquestion_ibfk_2` FOREIGN KEY (`testsectionid`) REFERENCES `tbltestsection` (`testsectionid`) ON DELETE CASCADE;
