...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = '/question_authoring/imagesiatinymce'; // Relative to domain name
	//$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] . $config['img_path']; // Physical path. [Usually works fine like this]
	$config['upload_path'] = '/var/www/tetfund/question_authoring/imagesiatinymce'; // Physical path. [Usually works fine like this]
