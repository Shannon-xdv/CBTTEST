...
<head>
   ...
   <title>Admin Toolbox<?php echo $pgtitle; ?></title>
         ...
         <div class="mx-[30px] min-h-[calc(100vh-195px)] mb-[30px] ssm:mt-[30px] mt-[15px]">
            <div class="grid grid-cols-12 gap-[25px]">
               <div class="col-span-12">
                  ...
                  <div class="text-center text-2xl font-bold mb-8 text-dark dark:text-title-dark">ADMIN TOOLBOX</div>
                     <div class="flex flex-row gap-6 mt-6">
                        <div class="w-[260px] min-w-[220px]">
                           <ul class="space-y-2">
                              <li><a class="anchor block px-4 py-2 rounded hover:bg-primary/10 hover:text-primary dark:hover:text-title-dark dark:hover:bg-box-dark-up transition" href="<?php echo siteUrl('admin_toolbox/manage_candidate_type/index.php')?>" target="contentframe">Manage Candidate Type</a></li>
                              <li><a class="anchor block px-4 py-2 rounded hover:bg-primary/10 hover:text-primary dark:hover:text-title-dark dark:hover:bg-box-dark-up transition" href="<?php echo siteUrl('admin_toolbox/manage_cvs/index.php') ?>" target="contentframe">Manage Center, Venue & System</a></li>
                              <li><a class="anchor block px-4 py-2 rounded hover:bg-primary/10 hover:text-primary dark:hover:text-title-dark dark:hover:bg-box-dark-up transition" href="<?php echo siteUrl('admin_toolbox/manage_students/index.php') ?>" target="contentframe">Manage Student</a></li>
                              <li><a class="anchor block px-4 py-2 rounded hover:bg-primary/10 hover:text-primary dark:hover:text-title-dark dark:hover:bg-box-dark-up transition" href="<?php echo siteUrl('admin_toolbox/manage_students/upload_student_images.php') ?>" target="contentframe">Upload Passports</a></li>
                              <li><a class="anchor block px-4 py-2 rounded hover:bg-primary/10 hover:text-primary dark:hover:text-title-dark dark:hover:bg-box-dark-up transition" href="<?php echo siteUrl('admin_toolbox/manage_jamb/index.php') ?>" target="contentframe">Manage Jamb Candidates</a></li>
                              <li><a class="anchor block px-4 py-2 rounded hover:bg-primary/10 hover:text-primary dark:hover:text-title-dark dark:hover:bg-box-dark-up transition" href="<?php echo siteUrl('admin_toolbox/manage_subject/index.php') ?>" target="contentframe">Manage Subjects</a></li>
                              <li><a class="anchor block px-4 py-2 rounded hover:bg-primary/10 hover:text-primary dark:hover:text-title-dark dark:hover:bg-box-dark-up transition" href="<?php echo siteUrl('admin_toolbox/invigilators/index.php') ?>" target="contentframe">Invigilators Toolkit</a></li>
                              <li><a class="anchor block px-4 py-2 rounded hover:bg-primary/10 hover:text-primary dark:hover:text-title-dark dark:hover:bg-box-dark-up transition" href="<?php echo siteUrl('admin_toolbox/avalable_students/index.php') ?>" target="contentframe">Available Students</a></li>
                           </ul>
                        </div>
                        <div class="flex-1">
