        ...
        foreach ($allcandidates as $candidate) {
            ...
            foreach ($tsubj as $sbj) {
                ...
                if (in_array($sbj, $rsubj)) {
                    ...
                    $rw .= "<td class='fsb" . $sbj . " " . ((!in_array("subjscore", $fields) || ($fsubj != "" && $sbj != $fsubj)) ? ("filtered") : ("")) . "'>$aggregate </td>";
                } else {
                    if ($fsubj != "") {
                        $toecho = false;
                    }
                    $rw .= "<td class='fsb" . $sbj . " " . ((!in_array("subjscore", $fields) || ($fsubj != "" && $sbj != $fsubj)) ? ("filtered") : ("")) . "'> - </td>";
                }
            }
