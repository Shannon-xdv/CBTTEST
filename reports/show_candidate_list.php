...
$fsubj = (isset($_POST['tsubjs']) ? (array($_POST['tsubjs'])) : (get_subject_combination_as_array($tid)));
if (count($fsubj) == 0) {
    ...
    foreach ($fsubj as $sbj)
    {
        ...
        foreach($questions as $question)
        {
           // echo"enesi";
            ...
            <li class='correctstat'><b>No of passed: </b> $passcount</li>
            <li class='wrongstat'><b>No of failed: </b> $failcount</li>
            <li class='nooptionstat'><b>No of no response: </b> $nooptioncount</li>
