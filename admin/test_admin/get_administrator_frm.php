...
$test_administrator= get_staff_userid($pno);
if($test_administrator==0)
{
...
if(is_test_administrator($test_administrator))
{
    echo"Already a test administrator";
    exit();
}
?>
<table>
    ...
    <tr><td>P. No.:</td><td><?php echo strtoupper(str_replace(".","",$pno)); ?><input type="hidden" name="uid" value="<?php echo $test_administrator; ?>"</td></tr>
