...
<body class="bg-white dark:bg-main-dark font-jost relative text-[15px] font-normal leading-[1.5] m-0 p-0">
   ...
   <div class="relative flex flex-col flex-1 !transition-all !duration-[0.2s] ease-linear delay-[0s] bg-normalBG dark:bg-main-dark" id="content">
      ...
      <main class="bg-normalBG dark:bg-main-dark">
         ...
         <div class="text-center text-2xl font-bold mb-8 text-dark dark:text-title-dark">TEST CONFIGURATION</div>
<div id="container">
    <?php
    ...
    <div>
        ...
        foreach ($testids as $testid) {
            ...
            ?>
            <div class="sub-mod">
                <h2 class="coolh2"><a href="testpage.php?tid=<?php echo $testid; ?>" title="<?php echo $unique; ?>"><?php echo $unique; ?></a><?php if ($test_config['status'] == 0)
