...
<head>
   ...
   <title>Test Configuration<?php echo $pgtitle; ?></title>
...
<body class="bg-white dark:bg-main-dark font-jost relative text-[15px] font-normal leading-[1.5] m-0 p-0">
   ...
   <div class="relative flex flex-col flex-1 !transition-all !duration-[0.2s] ease-linear delay-[0s] bg-normalBG dark:bg-main-dark" id="content">
      ...
      <main class="bg-normalBG dark:bg-main-dark">
         ...
         <div class="text-center text-2xl font-bold mb-8 text-dark dark:text-title-dark"><?php echo $unique; ?></div>
            ...
            <div class="w-auto mb-4 md:mb-0" style="min-width:220px;max-width:260px;">
                <div class="bg-white dark:bg-box-dark rounded-[10px] p-4 shadow flex flex-col gap-2">
                    ...
                    <?php if (is_test_administrator_of($testid)) { ?>
                        <a class="w-full flex items-center px-[15px] py-[10px] gap-[12px] rounded-md group text-body dark:text-subtitle-dark m-0 hover:text-primary hover:bg-primary/10 transition text-[15px]<?php if($lk=="basic") echo ' bg-primary/10 text-primary'; ?>" id="lk-basic" href="basic_config/basic_config.php?tid=<?php echo $testid; ?>" target="contentframe">
                            <i class="uil uil-cog"></i>
                            <span>Basic Configurations</span>
                        </a>
                        <a class="w-full flex items-center px-[15px] py-[10px] gap-[12px] rounded-md group text-body dark:text-subtitle-dark m-0 hover:text-primary hover:bg-primary/10 transition text-[15px]<?php if($lk=="version") echo ' bg-primary/10 text-primary'; ?>" id="lk-version" href="test_version/test_version.php?tid=<?php echo $testid; ?>" target="contentframe">
                            <i class="uil uil-layers"></i>
                            <span>Test Versions</span>
                        </a>
                        <a class="w-full flex items-center px-[15px] py-[10px] gap-[12px] rounded-md group text-body dark:text-subtitle-dark m-0 hover:text-primary hover:bg-primary/10 transition text-[15px]<?php if($lk=="date") echo ' bg-primary/10 text-primary'; ?>" id="lk-date" href="test_date/test_date.php?tid=<?php echo $testid; ?>" target="contentframe">
                            <i class="uil uil-calendar-alt"></i>
                            <span>Test Dates</span>
                        </a>
                        <a class="w-full flex items-center px-[15px] py-[10px] gap-[12px] rounded-md group text-body dark:text-subtitle-dark m-0 hover:text-primary hover:bg-primary/10 transition text-[15px]<?php if($lk=="schedule") echo ' bg-primary/10 text-primary'; ?>" id="lk-schedule" href="test_schedule/test_schedule.php?tid=<?php echo $testid; ?>" target="contentframe">
                            <i class="uil uil-schedule"></i>
                            <span>Test Schedules</span>
                        </a>
                        <?php if($test_config['testcodeid']==1){ ?>
                        <a class="w-full flex items-center px-[15px] py-[10px] gap-[12px] rounded-md group text-body dark:text-subtitle-dark m-0 hover:text-primary hover:bg-primary/10 transition text-[15px]<?php if($lk=="mapping") echo ' bg-primary/10 text-primary'; ?>" id="lk-mapping" href="test_mapping/test_mapping.php?tid=<?php echo $testid; ?>" target="contentframe">
                            <i class="uil uil-map"></i>
                            <span>Test Mapping</span>
                        </a>
                        <?php } ?>
                        <?php if($test_config['testcodeid']==1){ ?>
                        <a class="w-full flex items-center px-[15px] py-[10px] gap-[12px] rounded-md group text-body dark:text-subtitle-dark m-0 hover:text-primary hover:bg-primary/10 transition text-[15px]<?php if($lk=="upload") echo ' bg-primary/10 text-primary'; ?>" id="lk-upload" href="test_candidate_upload/single_candidate_upload.php?tid=<?php echo $testid; ?>" target="contentframe">
                            <i class="uil uil-user-plus"></i>
                            <span>Manual Candidate Scheduling</span>
                        </a>
                        <?php } else { ?>
                        <a class="w-full flex items-center px-[15px] py-[10px] gap-[12px] rounded-md group text-body dark:text-subtitle-dark m-0 hover:text-primary hover:bg-primary/10 transition text-[15px]<?php if($lk=="upload") echo ' bg-primary/10 text-primary'; ?>" id="lk-upload" href="test_candidate_upload/upload_process.php?tid=<?php echo $testid; ?>" target="contentframe">
                            <i class="uil uil-upload"></i>
                            <span>Upload Student list</span>
                        </a>
                        <?php } ?>
                        <a class="w-full flex items-center px-[15px] py-[10px] gap-[12px] rounded-md group text-body dark:text-subtitle-dark m-0 hover:text-primary hover:bg-primary/10 transition text-[15px]<?php if($lk=="subject") echo ' bg-primary/10 text-primary'; ?>" id="lk-subject" href="test_subject/test_subject.php?tid=<?php echo $testid; ?>" target="contentframe">
                            <i class="uil uil-book-open"></i>
                            <span>Test Subjects</span>
                        </a>
                    <?php }
                    if (is_test_administrator_of($testid) || is_test_compositor_of($testid)) { ?>
                        <a class="w-full flex items-center px-[15px] py-[10px] gap-[12px] rounded-md group text-body dark:text-subtitle-dark m-0 hover:text-primary hover:bg-primary/10 transition text-[15px]<?php if($lk=="compose") echo ' bg-primary/10 text-primary'; ?><?php if (!is_test_administrator_of($testid)) echo ' font-semibold'; ?>" id="lk-compose" href="test_composition/test_composition.php?tid=<?php echo $testid; ?>" target="contentframe">
                            <i class="uil uil-edit"></i>
                            <span>Test Composition</span>
                        </a>
                    <?php }
                    if (is_test_administrator_of($testid) || is_test_compositor_of($testid) || is_question_viewer_of($testid)) { ?>
                        <a class="w-full flex items-center px-[15px] py-[10px] gap-[12px] rounded-md group text-body dark:text-subtitle-dark m-0 hover:text-primary hover:bg-primary/10 transition text-[15px]<?php if($lk=="preview") echo ' bg-primary/10 text-primary'; ?>" id="lk-preview" href="quest_viewer/quest_viewer.php?tid=<?php echo $testid; ?>" target="contentframe">
                            <i class="uil uil-eye"></i>
                            <span>Preview Test Questions</span>
                        </a>
                    <?php }
                    if (is_test_administrator_of($testid)) { ?>
                        <a class="w-full flex items-center px-[15px] py-[10px] gap-[12px] rounded-md group text-body dark:text-subtitle-dark m-0 hover:text-primary hover:bg-primary/10 transition text-[15px]<?php if($lk=="user") echo ' bg-primary/10 text-primary'; ?>" id="lk-user" href="test_user/test_user.php?tid=<?php echo $testid; ?>" target="contentframe">
   ...
   <script type="text/javascript">
function onBasicConfigSaved() {
    var iframe = document.getElementById('contentframe');
    if (iframe) {
        iframe.contentWindow.location.reload();
    }
    // Optionally, show a notification here
    // alert("Basic configuration updated!");
}
</script>
</body>
</html>